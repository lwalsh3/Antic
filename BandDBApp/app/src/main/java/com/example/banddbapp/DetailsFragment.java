...
public class DetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String currentImageRef = mBand.getDescription();
        int imageId = this.getResources().getIdentifier(currentImageRef, "drawable", "com.example.banddbapp");

        ImageView descriptionTextView = (ImageView) view.findViewById(R.id.bandDescription);
